...
def crop_image_box(bbx_data):
    startX = min(bbx_data[0][0][0], bbx_data[1][0][0], bbx_data[2][0][0], bbx_data[3][0][0])
    startY = min(bbx_data[0][0][1], bbx_data[1][0][1], bbx_data[2][0][1],
                       bbx_data[3][0][1])
    endX = max(bbx_data[0][0][0], bbx_data[1][0][0], bbx_data[2][0][0], bbx_data[3][0][0])
    endY = max(bbx_data[0][0][1], bbx_data[1][0][1], bbx_data[2][0][1],
                       bbx_data[3][0][1])
